...
const Engine::Math::Vector3 TestScene::tPos1 = { -1.0f, -1.0f, 0.0f };
const Engine::Math::Vector3 TestScene::tPos2 = { 0.0f, 1.0f, 0.0f };
const Engine::Math::Vector3 TestScene::tPos3 = { 1.0f, -1.0f, 0.0f };
